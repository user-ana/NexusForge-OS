...
function LoginPageContent() {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      ...
      document.cookie = "nf_mock_user=; path=/; expires=Thu, 01 Jan 1970 00:00:00 GMT; SameSite=Lax";
    }
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    if (err) {
      ...
      // El middleware ya se encargará de redirigir, pero por si acaso:
          ...
          <div>
            <div className="flex justify-between items-center mb-1.5">
              ...
              <Link
                ...
                onClick={(e) => {
                  e.preventDefault();
                  alert("Contacta con el administrador de la forja para recuperar accesos.");
                }}
